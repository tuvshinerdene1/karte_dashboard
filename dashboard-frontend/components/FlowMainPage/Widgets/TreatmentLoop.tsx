// components/widgets/TreatmentLoopMetricsWidget.tsx
'use client';
...
export default function TreatmentLoopMetricsWidget() {
  const { patientsInTreatmentLoop } = useHealthcareFlowStore();

  if (patientsInTreatmentLoop.length === 0) {
    return null;
  }
